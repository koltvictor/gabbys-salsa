export default function About () {
    return (
        <div className="about">
            <h1>About Gabby</h1>
            <p>La Mexicana is a maker of salsas made with farm-fresh ingredients. We source our ingredients from farms that grow the freshest vegetables year ’round — firm sun-ripened tomatoes, crisp onion, zesty jalapeño, and fresh cilantro.
